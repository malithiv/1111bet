...
const DiceRollingGame = () => {
  ...
  const userId = localStorage.getItem('user_id');
    ...
    const handleRoll = (value) => {
        setDiceValue(value);
        // You can add additional logic here, such as processing bets or updating the UI
    ...
    return (
        <div style={styles.container}>
            ...
            <Dice 
                face={diceValue} 
                onRoll={handleRoll} 
                rollDuration={1000} // Duration of the roll animation in milliseconds
            />
            <button onClick={() => handleRoll(Math.floor(Math.random() * 6) + 1)}>Roll Dice</button>
...
//   fetch('http://145.223.21.62:3008/dicewin', {
//     method: 'POST',
//     headers: {
...
//     fetch('http://145.223.21.62:3008/dicebet', {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
